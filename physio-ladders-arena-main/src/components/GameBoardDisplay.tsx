...
export const GameBoardDisplay: React.FC<GameBoardDisplayProps> = ({
  ...
  return (
    <Card className="p-4 bg-black">
      <div className="relative w-full max-w-4xl mx-auto bg-black rounded-lg">
        <img 
          src="/lovable-uploads/a5adee1b-1209-4018-b9d1-7e9f5dec182d.png" 
          alt="Snakes and Ladders Board"
          className="w-full h-auto rounded-lg shadow-lg object-contain max-h-[60vh] lg:max-h-[75vh]"
          style={{ 
  width: '100%',
  height: 'auto',
        ...
        {playerPositions.map((position, index) => (
          <div 
            ...
            style={{
              ...
              transform: `translate(${index * 3 - 5}px, ${index * -3 + 5}px)`
            }}
